/* PgSlider */
(function(d,c,b,e){function a(f,h,g){if(h.charAt(0)==="*"){f[h.substring(1)]=g
        }
        else
        {
            f["-ms-"+h]=g;
            f["-webkit-"+h]=g;
            f[h]=g}}d.fn.precss=function(g){
        ...
        (function(d,f,g,a)
        {
            var c=function(n)
            {
                ...
                var j=null;n=n.toLowerCase();
                if(o.style[n]){m=true}if(m===false)
                {
                    j=n.charAt(0).toUpperCase()+n.substr(1);
                    for(var k=0;k<l.length;k++)
                    {
                        if(o.style[l[k]+j]!==a){m=true;break}
                    }
                }return m};
                var i={};
